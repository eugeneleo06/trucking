...
?>
                ...
                <tbody>
                  ...
                  foreach($vendor as $i=>$v):
                    echo '<tr>';
                      ...
                      echo '<td>';
                      echo '<a class="edit-btn" href="upsert_vendor.php?q='.$v['secure_id'].'"><i class="fas fa-lg fa-pencil-alt"></i></a>';
                      echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'; 
  ...
  <script>
        ...
        $('.delete-btn').click(function(event) {
            ...
            var deleteUrl = 'api/delete_vendor.php?q=' + secureId;
