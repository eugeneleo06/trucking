...
?>
              ...
              <table class="table datatable" id="dataTable">
                <thead>
                  <tr>
                    ...
                    <th>Username</th>
                    <th>Role</th>
                    <?php if ($_SESSION['role'] != "MEMBER" && $_SESSION['role'] != "ADMIN"):?>
                    <th>Action</th>
                    <?php endif;?>
                  </tr>
                </thead>
                <tbody>
                  ...
                  foreach($user as $i=>$v):
                    echo '<tr>';
                      ...
                      echo '<td>'.ucfirst(strtolower($v['role'])).'</td>';
                      if ($_SESSION['role'] != "MEMBER" && $_SESSION['role'] != "ADMIN"):
                      echo '<td>';
                      echo '<a class="edit-btn" href="upsert_user.php?q='.$v['secure_id'].'"><i class="fas fa-lg fa-pencil-alt"></i></a>';
                      echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'; 
  ...
  <script>
        ...
        $('.delete-btn').click(function(event) {
            ...
            var deleteUrl = 'api/delete_user.php?q=' + secureId;
